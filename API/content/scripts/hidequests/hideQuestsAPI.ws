...
// Always let Script Merger replace this with file from the mod "Hide Quests" or have "Hide Quests" loaded before any other mod that uses this functionality.



/* Check if a quest is hidden
 * @remark  This is just a dummy. Actual implementation is provided by the mod "Hide Quests".
...
function modHideQuests_IsQuestHidden( questTitleStringId : int ) : bool
{
	...
	// ALWAYS LET SCRIPT MERGER REPLACE THIS WITH FUNCTION FROM THE MOD "Hide Quests".
	return false
}
